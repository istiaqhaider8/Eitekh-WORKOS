  ...
  try {
    ...
    const csv = buildTemplate({
      ...
      notes: [
        ...
        "startdate / duedate: DD/MM/YYYY, e.g. 15/10/2026 is 15 October. The DAY comes",
        "          first. A due date cannot precede the start date. Dashes and dots",
        "          also work (15-10-2026, 15.10.2026).",
        "",
        "          If your spreadsheet writes US-style dates (10/15/2026 meaning",
        "          15 October) those will be REJECTED, because 15 is not a month.",
        "          Format the two date columns as Text, or type them as DD/MM/YYYY.",
        "",
