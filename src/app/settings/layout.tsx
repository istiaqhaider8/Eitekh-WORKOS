  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <div className="flex-1 flex max-w-7xl mx-auto w-full overflow-hidden">
        {/* Settings Sidebar */}
        <aside className="w-64 border-r border-slate-300 dark:border-slate-800 p-6 flex flex-col">
          <button
            type="button"
            onClick={() => {
            ...
            className="flex items-center gap-2 text-xs font-semibold px-3 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all mb-6 cursor-pointer shadow-2xs"
          >
            <ArrowLeft className="w-3.5 h-3.5" />
            <span>Back to Dashboard</span>
          </button>

          <h2 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4 px-3">
            Settings
          </h2>
