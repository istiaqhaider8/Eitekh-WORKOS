                  ...
                  <tr key={log.id} className="hover:bg-slate-850/60 transition-colors">
                    ...
                    <td className="p-3 text-right">
                      <button
                        ...
                        className="px-2.5 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-700 text-slate-800 dark:text-slate-200 rounded text-xs font-medium border border-slate-300 dark:border-slate-700"
                      >
                        Inspect
                      </button>
                    </td>
